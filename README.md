...
*Important:* This project is, and should stay compatible with Python 2.6, 2.7 and Python 3.8+ up to 3.12, to keep the same Python compatibility that `skyfield` has. **Although**, recent changes in Github images have made it difficult to make sure that it's still compatible. We're sorry for the inconvenience.
